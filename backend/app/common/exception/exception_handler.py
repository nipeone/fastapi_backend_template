...
from backend.app.common.exception.error_message import (
...
async def _validation_exception_handler(request: Request, e: Union[RequestValidationError, ValidationError]):
    """
    数据验证异常处理
